...
print '<tr><td>';
print '<h3 style="text-align:center;align:center">Slices transmitting the most packets</h3>';
...
print '</td><td>';
print '<table>';
print '<h3 style="text-align:center;align:center">Slices transmitting the most data</h3>';
